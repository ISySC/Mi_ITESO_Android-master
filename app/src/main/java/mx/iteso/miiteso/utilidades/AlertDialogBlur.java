...
public class AlertDialogBlur extends SupportBlurDialogFragment {
     ...
     */
    public static AlertDialogBlur newInstance(int radius,
                                                          float downScaleFactor,
                                                          boolean dimming,
                                                          boolean debug,
                                                          boolean mBlurredActionBar,
                                                          boolean useRenderScript) {
        AlertDialogBlur fragment = new AlertDialogBlur();
